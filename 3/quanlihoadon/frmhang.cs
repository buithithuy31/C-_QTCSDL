...
namespace quanlihoadon
{
    ...
    {
        string sCon = "Data Source=.\\DESKTOP-B8N6V6G;Initial Catalog=nhaphang;Integrated Security=True";
        public frmhang()
        {
            InitializeComponent();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
           ...
           // string sDonGiaBan = txtDongiaban.Text;
            ...
            string sQuery = "insert into HANGHOA values(@MaHH, @TenHH, @DonVi, @DonGia)";
